 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.DeploymentConfigurationImpl#getOwnedDeploymentLinks <em>Owned Deployment Links</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.DeploymentConfigurationImpl#getOwnedPhysicalInstances <em>Owned Physical Instances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentConfigurationImpl extends NamedElementImpl implements DeploymentConfiguration {
	...
	public EList<AbstractDeploymentLink> getOwnedDeploymentLinks() {
		if (ownedDeploymentLinks == null) {
			ownedDeploymentLinks = new EObjectContainmentEList<AbstractDeploymentLink>(AbstractDeploymentLink.class, this, DeploymentPackage.DEPLOYMENT_CONFIGURATION__OWNED_DEPLOYMENT_LINKS);
		}
	...
	public EList<AbstractPhysicalInstance> getOwnedPhysicalInstances() {
		if (ownedPhysicalInstances == null) {
			ownedPhysicalInstances = new EObjectContainmentEList<AbstractPhysicalInstance>(AbstractPhysicalInstance.class, this, DeploymentPackage.DEPLOYMENT_CONFIGURATION__OWNED_PHYSICAL_INSTANCES);
		}
