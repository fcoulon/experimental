 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.PhysicalArchitecturePkg#getOwnedPhysicalArchitecturePkgs <em>Owned Physical Architecture Pkgs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.PhysicalArchitecturePkg#getOwnedPhysicalArchitectures <em>Owned Physical Architectures</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalArchitecturePkg()
...
public interface PhysicalArchitecturePkg extends BlockArchitecturePkg {
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.pa.PhysicalArchitecturePkg}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalArchitecturePkg_OwnedPhysicalArchitecturePkgs()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalArchitecturePkg_OwnedPhysicalArchitectures()
	 * @model containment="true"
	 *        annotation="http://www.polarsys.org/capella/2007/UML2Mapping featureName='packagedElement' featureOwner='Package'"
