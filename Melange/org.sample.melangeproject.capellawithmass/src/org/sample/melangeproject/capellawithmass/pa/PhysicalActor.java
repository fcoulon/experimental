 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.PhysicalActor#getOwnedLogicalActorRealizations <em>Owned Logical Actor Realizations</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.PhysicalActor#getLogicalActorRealizations <em>Logical Actor Realizations</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.PhysicalActor#getAllocatedPhysicalFunctions <em>Allocated Physical Functions</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.PhysicalActor#getRealizedLogicalActors <em>Realized Logical Actors</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.PhysicalActor#getDeployedPhysicalComponents <em>Deployed Physical Components</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalActor()
...
public interface PhysicalActor extends AbstractPhysicalComponent, AbstractActor {
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.pa.LogicalActorRealization}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalActor_OwnedLogicalActorRealizations()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalActor_LogicalActorRealizations()
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.pa.PhysicalFunction#getAllocatorPhysicalActors <em>Allocator Physical Actors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalActor_AllocatedPhysicalFunctions()
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.la.LogicalActor#getRealizingPhysicalActors <em>Realizing Physical Actors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalActor_RealizedLogicalActors()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.PaPackage#getPhysicalActor_DeployedPhysicalComponents()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='keyword::none' explanation='Derived and transient' constraints='none'"
	 * @generated
	 */
