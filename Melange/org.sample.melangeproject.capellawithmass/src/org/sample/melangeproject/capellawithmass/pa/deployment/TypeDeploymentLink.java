...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Type Deployment Link</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.sample.melangeproject.capellawithmass.pa.deployment.DeploymentPackage#getTypeDeploymentLink()
 * @model annotation="http://www.polarsys.org/capella/2007/BusinessInformation Label='TypeDeploymentLink'"
 *        annotation="http://www.polarsys.org/capella/2007/UML2Mapping metaclass='Dependency' stereotype='eng.TypeDeploymentLink'"
 *        annotation="http://www.polarsys.org/kitalpha/ecore/documentation description='deployment link between a data type and the model element that deploys it\r\n[source: Capella study]' usage\040guideline='n/a' used\040in\040levels='n/a' usage\040examples='n/a' constraints='none' comment/notes='none' reference\040documentation='none'"
