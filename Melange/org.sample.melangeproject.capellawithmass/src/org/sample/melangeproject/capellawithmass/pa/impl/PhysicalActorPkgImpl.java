 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.impl.PhysicalActorPkgImpl#getOwnedPhysicalActorPkgs <em>Owned Physical Actor Pkgs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.impl.PhysicalActorPkgImpl#getOwnedPhysicalActors <em>Owned Physical Actors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PhysicalActorPkgImpl extends AbstractFunctionalStructureImpl implements PhysicalActorPkg {
	...
	public EList<PhysicalActorPkg> getOwnedPhysicalActorPkgs() {
		if (ownedPhysicalActorPkgs == null) {
			ownedPhysicalActorPkgs = new EObjectContainmentEList<PhysicalActorPkg>(PhysicalActorPkg.class, this, PaPackage.PHYSICAL_ACTOR_PKG__OWNED_PHYSICAL_ACTOR_PKGS);
		}
	...
	public EList<PhysicalActor> getOwnedPhysicalActors() {
		if (ownedPhysicalActors == null) {
			ownedPhysicalActors = new EObjectContainmentEList<PhysicalActor>(PhysicalActor.class, this, PaPackage.PHYSICAL_ACTOR_PKG__OWNED_PHYSICAL_ACTORS);
		}
