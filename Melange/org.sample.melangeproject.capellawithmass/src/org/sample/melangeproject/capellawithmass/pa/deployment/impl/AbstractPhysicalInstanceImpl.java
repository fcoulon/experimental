 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getIncomingTraces <em>Incoming Traces</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOutgoingTraces <em>Outgoing Traces</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#isVisibleInDoc <em>Visible In Doc</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#isVisibleInLM <em>Visible In LM</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getReview <em>Review</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOwnedPropertyValues <em>Owned Property Values</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOwnedEnumerationPropertyTypes <em>Owned Enumeration Property Types</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getAppliedPropertyValues <em>Applied Property Values</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getOwnedPropertyValueGroups <em>Owned Property Value Groups</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getAppliedPropertyValueGroups <em>Applied Property Value Groups</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.impl.AbstractPhysicalInstanceImpl#getAppliedRequirements <em>Applied Requirements</em>}</li>
 * </ul>
 *
 * @generated
 */
