 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.ComponentInstance#getPortInstances <em>Port Instances</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.ComponentInstance#getOwnedAbstractPhysicalInstances <em>Owned Abstract Physical Instances</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.ComponentInstance#getOwnedInstanceDeploymentLinks <em>Owned Instance Deployment Links</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.pa.deployment.ComponentInstance#getType <em>Type</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.pa.deployment.DeploymentPackage#getComponentInstance()
...
public interface ComponentInstance extends AbstractPhysicalInstance, DeployableElement, DeploymentTarget {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.deployment.DeploymentPackage#getComponentInstance_PortInstances()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.pa.deployment.AbstractPhysicalInstance}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.deployment.DeploymentPackage#getComponentInstance_OwnedAbstractPhysicalInstances()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.pa.deployment.InstanceDeploymentLink}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.deployment.DeploymentPackage#getComponentInstance_OwnedInstanceDeploymentLinks()
	 * @model containment="true"
	 *        annotation="http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='' explanation='none' constraints='none'"
	 * @generated
	 */
	 ...
	 * @see org.sample.melangeproject.capellawithmass.pa.deployment.DeploymentPackage#getComponentInstance_Type()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.pa.deployment.ComponentInstance#getType <em>Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
