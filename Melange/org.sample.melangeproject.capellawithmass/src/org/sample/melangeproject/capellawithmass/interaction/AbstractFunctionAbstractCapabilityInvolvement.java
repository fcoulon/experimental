 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.interaction.AbstractFunctionAbstractCapabilityInvolvement#getCapability <em>Capability</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.interaction.AbstractFunctionAbstractCapabilityInvolvement#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.interaction.InteractionPackage#getAbstractFunctionAbstractCapabilityInvolvement()
...
public interface AbstractFunctionAbstractCapabilityInvolvement extends Involvement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.interaction.InteractionPackage#getAbstractFunctionAbstractCapabilityInvolvement_Capability()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.interaction.InteractionPackage#getAbstractFunctionAbstractCapabilityInvolvement_Function()
	 * @model required="true" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='keyword::none' explanation='Derived and transient' constraints='none'"
	 * @generated
	 */
