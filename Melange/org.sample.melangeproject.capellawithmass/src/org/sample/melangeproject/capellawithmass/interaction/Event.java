 ...
 *
 *
 * @see org.sample.melangeproject.capellawithmass.interaction.InteractionPackage#getEvent()
 * @model abstract="true"
 *        annotation="http://www.polarsys.org/capella/2007/BusinessInformation Label='Event'"
 *        annotation="http://www.polarsys.org/capella/2007/UML2Mapping metaclass='Event'"
 *        annotation="http://www.polarsys.org/kitalpha/ecore/documentation description='Event is similar to UML MessageEvent : A message event specifies the receipt by an object of either a call or a signal. MessageEvent is an abstract metaclass.\r\n[source:UML Superstructure v2.2]' usage\040guideline='n/a (Abstract)' used\040in\040levels='operational, system, logical, physical' usage\040examples='n/a' constraints='none' comment/notes='none' reference\040documentation='none'"
