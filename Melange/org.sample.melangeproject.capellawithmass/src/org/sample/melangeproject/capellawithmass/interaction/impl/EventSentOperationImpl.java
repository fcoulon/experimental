...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Event Sent Operation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.interaction.impl.EventSentOperationImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventSentOperationImpl extends EventImpl implements EventSentOperation {
	 ...
	 * @generated
	 */
	protected EventSentOperationImpl() {
		super();
	}
		...
		if (operation != null && operation.eIsProxy()) {
			...
			if (operation != oldOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InteractionPackage.EVENT_SENT_OPERATION__OPERATION, oldOperation, operation));
			}
		}
		return operation;
	}
	...
	public void setOperation(AbstractEventOperation newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.EVENT_SENT_OPERATION__OPERATION, oldOperation, operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InteractionPackage.EVENT_SENT_OPERATION__OPERATION:
