 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.interaction.AbstractEnd#getEvent <em>Event</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.interaction.AbstractEnd#getCovered <em>Covered</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.interaction.InteractionPackage#getAbstractEnd()
 * @model abstract="true"
...
public interface AbstractEnd extends InteractionFragment {
	 ...
	 * @see #setEvent(Event)
	 * @see org.sample.melangeproject.capellawithmass.interaction.InteractionPackage#getAbstractEnd_Event()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.interaction.AbstractEnd#getEvent <em>Event</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.interaction.InstanceRole#getAbstractEnds <em>Abstract Ends</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.interaction.InteractionPackage#getAbstractEnd_Covered()
