 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.interaction.impl.AbstractFragmentImpl#getOwnedGates <em>Owned Gates</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractFragmentImpl extends TimeLapseImpl implements AbstractFragment {
	...
	public EList<Gate> getOwnedGates() {
		if (ownedGates == null) {
			ownedGates = new EObjectContainmentEList<Gate>(Gate.class, this, InteractionPackage.ABSTRACT_FRAGMENT__OWNED_GATES);
		}
		return ownedGates;
	}
