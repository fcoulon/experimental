 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#isMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#isMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedDefaultValue <em>Owned Default Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedMinValue <em>Owned Min Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedMaxValue <em>Owned Max Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedNullValue <em>Owned Null Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedMinCard <em>Owned Min Card</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedMinLength <em>Owned Min Length</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedMaxCard <em>Owned Max Card</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedMaxLength <em>Owned Max Length</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedPropertyValuePkgs <em>Owned Property Value Pkgs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getOwnedDataValues <em>Owned Data Values</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#isIsPrimitive <em>Is Primitive</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getAggregationKind <em>Aggregation Kind</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionImpl#getContainedOperations <em>Contained Operations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionImpl extends ClassifierImpl implements Collection {
	...
	public EList<PropertyValuePkg> getOwnedPropertyValuePkgs() {
		if (ownedPropertyValuePkgs == null) {
			ownedPropertyValuePkgs = new EObjectContainmentEList<PropertyValuePkg>(PropertyValuePkg.class, this, InformationPackage.COLLECTION__OWNED_PROPERTY_VALUE_PKGS);
		}
