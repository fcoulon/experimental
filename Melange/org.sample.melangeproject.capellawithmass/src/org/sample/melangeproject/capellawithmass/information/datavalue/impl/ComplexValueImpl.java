 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.datavalue.impl.ComplexValueImpl#getOwnedParts <em>Owned Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexValueImpl extends AbstractComplexValueImpl implements ComplexValue {
	...
	public EList<ValuePart> getOwnedParts() {
		if (ownedParts == null) {
			ownedParts = new EObjectContainmentEList<ValuePart>(ValuePart.class, this, DatavaluePackage.COMPLEX_VALUE__OWNED_PARTS);
		}
		return ownedParts;
	}
