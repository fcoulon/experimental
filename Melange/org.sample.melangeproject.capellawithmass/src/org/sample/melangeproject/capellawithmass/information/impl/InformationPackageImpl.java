...
public class InformationPackageImpl extends EPackageImpl implements InformationPackage {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.information.InformationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(classEClass, org.sample.melangeproject.capellawithmass.information.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_IsPrimitive(), ecorePackage.getEBoolean(), "isPrimitive", null, 0, 1, org.sample.melangeproject.capellawithmass.information.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_KeyParts(), this.getKeyPart(), null, "keyParts", null, 0, -1, org.sample.melangeproject.capellawithmass.information.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_OwnedStateMachines(), theCapellacommonPackage.getStateMachine(), null, "ownedStateMachines", null, 0, -1, org.sample.melangeproject.capellawithmass.information.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_OwnedDataValues(), theDatavaluePackage.getDataValue(), null, "ownedDataValues", null, 0, -1, org.sample.melangeproject.capellawithmass.information.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_OwnedInformationRealizations(), this.getInformationRealization(), null, "ownedInformationRealizations", null, 0, -1, org.sample.melangeproject.capellawithmass.information.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_RealizedClasses(), this.getClass_(), this.getClass_RealizingClasses(), "realizedClasses", null, 0, -1, org.sample.melangeproject.capellawithmass.information.Class.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getClass_RealizingClasses(), this.getClass_(), this.getClass_RealizedClasses(), "realizingClasses", null, 0, -1, org.sample.melangeproject.capellawithmass.information.Class.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
