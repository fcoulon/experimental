 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionValueImpl#getOwnedElements <em>Owned Elements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.CollectionValueImpl#getOwnedDefaultElement <em>Owned Default Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionValueImpl extends AbstractCollectionValueImpl implements CollectionValue {
	...
	public EList<DataValue> getOwnedElements() {
		if (ownedElements == null) {
			ownedElements = new EObjectContainmentEList<DataValue>(DataValue.class, this, InformationPackage.COLLECTION_VALUE__OWNED_ELEMENTS);
		}
