 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getAbstractType <em>Abstract Type</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isOrdered <em>Ordered</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedDefaultValue <em>Owned Default Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedMinValue <em>Owned Min Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedMaxValue <em>Owned Max Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedNullValue <em>Owned Null Value</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedMinCard <em>Owned Min Card</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedMinLength <em>Owned Min Length</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedMaxCard <em>Owned Max Card</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getOwnedMaxLength <em>Owned Max Length</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getAggregationKind <em>Aggregation Kind</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isIsReadOnly <em>Is Read Only</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#isIsPartOfKey <em>Is Part Of Key</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.impl.PropertyImpl#getAssociation <em>Association</em>}</li>
 * </ul>
 *
 * @generated
 */
