...
public class InformationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InformationPackage.CLASS: {
				org.sample.melangeproject.capellawithmass.information.Class class_ = (org.sample.melangeproject.capellawithmass.information.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(org.sample.melangeproject.capellawithmass.information.Class object) {
		return null;
	}
