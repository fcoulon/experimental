...
public class CommunicationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommunicationPackage.EXCEPTION: {
				org.sample.melangeproject.capellawithmass.information.communication.Exception exception = (org.sample.melangeproject.capellawithmass.information.communication.Exception)theEObject;
	 ...
	 * @generated
	 */
	public T caseException(org.sample.melangeproject.capellawithmass.information.communication.Exception object) {
		return null;
	}
