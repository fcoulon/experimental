 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.information.communication.impl.SignalImpl#getSignalInstances <em>Signal Instances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignalImpl extends CommunicationItemImpl implements Signal {
	...
	public EList<SignalInstance> getSignalInstances() {
		if (signalInstances == null) {
			signalInstances = new EObjectContainmentEList<SignalInstance>(SignalInstance.class, this, CommunicationPackage.SIGNAL__SIGNAL_INSTANCES);
		}
