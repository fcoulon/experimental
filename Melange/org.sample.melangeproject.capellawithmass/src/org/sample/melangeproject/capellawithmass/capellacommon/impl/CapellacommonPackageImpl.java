...
import org.sample.melangeproject.capellawithmass.capellacommon.CapellacommonFactory;
import org.sample.melangeproject.capellawithmass.capellacommon.CapellacommonPackage;
import org.sample.melangeproject.capellawithmass.capellacommon.ChangeEvent;
import org.sample.melangeproject.capellawithmass.capellacommon.ChangeEventKind;
import org.sample.melangeproject.capellawithmass.capellacommon.ChoicePseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.DeepHistoryPseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.EntryPointPseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.ExitPointPseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.FinalState;
import org.sample.melangeproject.capellawithmass.capellacommon.ForkPseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.GenericTrace;
import org.sample.melangeproject.capellawithmass.capellacommon.InitialPseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.JoinPseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.JustificationLink;
import org.sample.melangeproject.capellawithmass.capellacommon.Mode;
import org.sample.melangeproject.capellawithmass.capellacommon.Pseudostate;
import org.sample.melangeproject.capellawithmass.capellacommon.Region;
import org.sample.melangeproject.capellawithmass.capellacommon.ShallowHistoryPseudoState;
...
import org.sample.melangeproject.capellawithmass.capellacommon.TerminatePseudoState;
import org.sample.melangeproject.capellawithmass.capellacommon.TimeEvent;
import org.sample.melangeproject.capellawithmass.capellacommon.TimeEventKind;
import org.sample.melangeproject.capellawithmass.capellacommon.TransfoLink;
...
public class CapellacommonPackageImpl extends EPackageImpl implements CapellacommonPackage {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.capellacommon.CapellacommonPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getAbstractState_Outgoing(), this.getStateTransition(), this.getStateTransition_Source(), "outgoing", null, 0, -1, AbstractState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAbstractState_Incoming(), this.getStateTransition(), this.getStateTransition_Target(), "incoming", null, 0, -1, AbstractState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getStateTransition_Source(), this.getAbstractState(), this.getAbstractState_Outgoing(), "source", null, 1, 1, StateTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStateTransition_Target(), this.getAbstractState(), this.getAbstractState_Incoming(), "target", null, 1, 1, StateTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
