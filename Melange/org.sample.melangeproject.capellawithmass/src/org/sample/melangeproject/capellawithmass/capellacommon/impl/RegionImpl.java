 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.capellacommon.impl.RegionImpl#getOwnedStates <em>Owned States</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.capellacommon.impl.RegionImpl#getOwnedTransitions <em>Owned Transitions</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.capellacommon.impl.RegionImpl#getInvolvedStates <em>Involved States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegionImpl extends NamedElementImpl implements Region {
	...
	public EList<AbstractState> getOwnedStates() {
		if (ownedStates == null) {
			ownedStates = new EObjectContainmentEList<AbstractState>(AbstractState.class, this, CapellacommonPackage.REGION__OWNED_STATES);
		}
		return ownedStates;
	}
	...
	public EList<StateTransition> getOwnedTransitions() {
		if (ownedTransitions == null) {
			ownedTransitions = new EObjectContainmentEList<StateTransition>(StateTransition.class, this, CapellacommonPackage.REGION__OWNED_TRANSITIONS);
		}
