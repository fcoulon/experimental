/**
 */
package org.sample.melangeproject.capellawithmass.modellingcore.util;
...
import org.sample.melangeproject.capellawithmass.modellingcore.*;
...
public class ModellingcoreAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sample.melangeproject.capellawithmass.modellingcore.AbstractParameterSet <em>Abstract Parameter Set</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
