...
import org.sample.melangeproject.capellawithmass.activity.AcceptEventAction;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.AcceptEventActionImpl#isIsUnmarshall <em>Is Unmarshall</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.AcceptEventActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AcceptEventActionImpl extends AbstractActionImpl implements AcceptEventAction {
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, ActivityPackage.ACCEPT_EVENT_ACTION__RESULT);
		}
		return result;
	}
