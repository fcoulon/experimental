 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ExecutableNode#getOwnedHandlers <em>Owned Handlers</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getExecutableNode()
 * @model abstract="true"
...
public interface ExecutableNode extends ActivityNode {
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.activity.ExceptionHandler}.
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.activity.ExceptionHandler#getProtectedNode <em>Protected Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getExecutableNode_OwnedHandlers()
