 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getLocalPrecondition <em>Local Precondition</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getLocalPostcondition <em>Local Postcondition</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getContext <em>Context</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getInputs <em>Inputs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getOutputs <em>Outputs</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getAbstractAction()
 * @model abstract="true"
...
public interface AbstractAction extends ExecutableNode, AbstractNamedElement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getAbstractAction_LocalPrecondition()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getLocalPrecondition <em>Local Precondition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getAbstractAction_LocalPostcondition()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getLocalPostcondition <em>Local Postcondition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getAbstractAction_Context()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.AbstractAction#getContext <em>Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.activity.InputPin}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getAbstractAction_Inputs()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.activity.OutputPin}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getAbstractAction_Outputs()
	 * @model containment="true"
