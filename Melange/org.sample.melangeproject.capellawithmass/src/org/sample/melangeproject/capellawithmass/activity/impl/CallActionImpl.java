 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.CallActionImpl#getResults <em>Results</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CallActionImpl extends InvocationActionImpl implements CallAction {
	...
	public EList<OutputPin> getResults() {
		if (results == null) {
			results = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, ActivityPackage.CALL_ACTION__RESULTS);
		}
		return results;
	}
