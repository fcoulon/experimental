 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getInActivityPartition <em>In Activity Partition</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getInInterruptibleRegion <em>In Interruptible Region</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getInStructuredNode <em>In Structured Node</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getAbstractType <em>Abstract Type</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#isIsControlType <em>Is Control Type</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getKindOfNode <em>Kind Of Node</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getInState <em>In State</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ObjectNodeImpl#getSelection <em>Selection</em>}</li>
 * </ul>
 *
 * @generated
 */
