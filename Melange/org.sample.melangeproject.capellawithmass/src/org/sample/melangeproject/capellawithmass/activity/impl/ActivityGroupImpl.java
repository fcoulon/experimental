 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ActivityGroupImpl#getSuperGroup <em>Super Group</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ActivityGroupImpl#getSubGroups <em>Sub Groups</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ActivityGroupImpl#getOwnedNodes <em>Owned Nodes</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.impl.ActivityGroupImpl#getOwnedEdges <em>Owned Edges</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ActivityGroupImpl extends ModelElementImpl implements ActivityGroup {
	...
	public EList<ActivityGroup> getSubGroups() {
		if (subGroups == null) {
			subGroups = new EObjectContainmentWithInverseEList<ActivityGroup>(ActivityGroup.class, this, ActivityPackage.ACTIVITY_GROUP__SUB_GROUPS, ActivityPackage.ACTIVITY_GROUP__SUPER_GROUP);
		}
		return subGroups;
	}
	...
	public EList<ActivityNode> getOwnedNodes() {
		if (ownedNodes == null) {
			ownedNodes = new EObjectContainmentEList<ActivityNode>(ActivityNode.class, this, ActivityPackage.ACTIVITY_GROUP__OWNED_NODES);
		}
		return ownedNodes;
	}
	...
	public EList<ActivityEdge> getOwnedEdges() {
		if (ownedEdges == null) {
			ownedEdges = new EObjectContainmentEList<ActivityEdge>(ActivityEdge.class, this, ActivityPackage.ACTIVITY_GROUP__OWNED_EDGES);
		}
		return ownedEdges;
	}
