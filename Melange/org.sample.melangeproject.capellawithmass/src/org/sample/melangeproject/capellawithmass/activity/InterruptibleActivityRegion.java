 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.InterruptibleActivityRegion#getInterruptingEdges <em>Interrupting Edges</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getInterruptibleActivityRegion()
 * @model abstract="true"
...
public interface InterruptibleActivityRegion extends ActivityGroup {
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.activity.ActivityEdge#getInterrupts <em>Interrupts</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getInterruptibleActivityRegion_InterruptingEdges()
