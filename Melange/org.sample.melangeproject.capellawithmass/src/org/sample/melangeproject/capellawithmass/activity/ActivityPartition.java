 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#isIsDimension <em>Is Dimension</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#isIsExternal <em>Is External</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#getRepresentedElement <em>Represented Element</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#getSuperPartition <em>Super Partition</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#getSubPartitions <em>Sub Partitions</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getActivityPartition()
 * @model abstract="true"
...
public interface ActivityPartition extends ActivityGroup, AbstractNamedElement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getActivityPartition_IsDimension()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#isIsDimension <em>Is Dimension</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getActivityPartition_IsExternal()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#isIsExternal <em>Is External</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getActivityPartition_RepresentedElement()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition#getRepresentedElement <em>Represented Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getActivityPartition_SuperPartition()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.activity.ActivityPartition}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getActivityPartition_SubPartitions()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
