 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#isIsControlType <em>Is Control Type</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getKindOfNode <em>Kind Of Node</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getInState <em>In State</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getSelection <em>Selection</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getObjectNode()
 * @model abstract="true"
...
public interface ObjectNode extends ActivityNode, AbstractTypedElement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getObjectNode_IsControlType()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#isIsControlType <em>Is Control Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link org.sample.melangeproject.capellawithmass.activity.ObjectNodeKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getObjectNode_KindOfNode()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getKindOfNode <em>Kind Of Node</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link org.sample.melangeproject.capellawithmass.activity.ObjectNodeOrderingKind}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getObjectNode_Ordering()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getOrdering <em>Ordering</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getObjectNode_UpperBound()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getUpperBound <em>Upper Bound</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.modellingcore.IState}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getObjectNode_InState()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.activity.ActivityPackage#getObjectNode_Selection()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.activity.ObjectNode#getSelection <em>Selection</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
