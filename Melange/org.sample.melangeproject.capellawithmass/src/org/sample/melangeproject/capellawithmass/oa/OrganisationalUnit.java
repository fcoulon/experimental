 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OrganisationalUnit#getOrganisationalUnitCompositions <em>Organisational Unit Compositions</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OrganisationalUnit#getCommunityOfInterestMemberships <em>Community Of Interest Memberships</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOrganisationalUnit()
...
public interface OrganisationalUnit extends NamedElement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOrganisationalUnit_OrganisationalUnitCompositions()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.oa.CommunityOfInterestComposition}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOrganisationalUnit_CommunityOfInterestMemberships()
