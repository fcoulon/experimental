 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.RolePkg#getOwnedRolePkgs <em>Owned Role Pkgs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.RolePkg#getOwnedRoles <em>Owned Roles</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getRolePkg()
...
public interface RolePkg extends Structure {
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.oa.RolePkg}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getRolePkg_OwnedRolePkgs()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getRolePkg_OwnedRoles()
	 * @model containment="true"
