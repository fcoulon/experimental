 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapability#getCompliances <em>Compliances</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapability#getConfigurations <em>Configurations</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapability#getOwnedEntityOperationalCapabilityInvolvements <em>Owned Entity Operational Capability Involvements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapability#getRealizingCapabilities <em>Realizing Capabilities</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapability#getInvolvedEntities <em>Involved Entities</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapability()
...
public interface OperationalCapability extends AbstractCapability, Namespace {
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.oa.ConceptCompliance}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapability_Compliances()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.oa.CapabilityConfiguration}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapability_Configurations()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.oa.EntityOperationalCapabilityInvolvement}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapability_OwnedEntityOperationalCapabilityInvolvements()
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.ctx.Capability#getRealizedOperationalCapabilities <em>Realized Operational Capabilities</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapability_RealizingCapabilities()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapability_InvolvedEntities()
