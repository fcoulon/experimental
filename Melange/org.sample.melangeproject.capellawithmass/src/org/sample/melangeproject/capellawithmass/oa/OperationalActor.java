 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalActor#getRealizingSystemActors <em>Realizing System Actors</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalActor()
...
public interface OperationalActor extends Entity {
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.ctx.Actor#getRealizedOperationalActors <em>Realized Operational Actors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalActor_RealizingSystemActors()
