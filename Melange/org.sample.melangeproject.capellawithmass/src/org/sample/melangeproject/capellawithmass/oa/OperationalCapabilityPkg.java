 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapabilityPkg#getOwnedOperationalCapabilities <em>Owned Operational Capabilities</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapabilityPkg#getOwnedOperationalCapabilityPkgs <em>Owned Operational Capability Pkgs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapabilityPkg#getOwnedCapabilityConfigurations <em>Owned Capability Configurations</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.oa.OperationalCapabilityPkg#getOwnedConceptCompliances <em>Owned Concept Compliances</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapabilityPkg()
...
public interface OperationalCapabilityPkg extends AbstractCapabilityPkg {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapabilityPkg_OwnedOperationalCapabilities()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.oa.OperationalCapabilityPkg}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapabilityPkg_OwnedOperationalCapabilityPkgs()
	 * @model containment="true"
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapabilityPkg_OwnedCapabilityConfigurations()
	 * @model containment="true"
	 ...
	 * @see org.sample.melangeproject.capellawithmass.oa.OaPackage#getOperationalCapabilityPkg_OwnedConceptCompliances()
	 * @model containment="true"
