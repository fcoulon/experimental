 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.capellacore.FloatPropertyValue#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.capellacore.CapellacorePackage#getFloatPropertyValue()
...
public interface FloatPropertyValue extends AbstractPropertyValue {
	 ...
	 * @see #setValue(float)
	 * @see org.sample.melangeproject.capellawithmass.capellacore.CapellacorePackage#getFloatPropertyValue_Value()
	 ...
	 *        annotation="http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='' explanation='value will be stored as a stereotype-specific property, of type Float' constraints='none'"
	 * @generated
	 */
	float getValue();

	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.capellacore.FloatPropertyValue#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
