 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.capellacore.impl.EnumerationPropertyTypeImpl#getOwnedLiterals <em>Owned Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationPropertyTypeImpl extends NamedElementImpl implements EnumerationPropertyType {
	...
	public EList<EnumerationPropertyLiteral> getOwnedLiterals() {
		if (ownedLiterals == null) {
			ownedLiterals = new EObjectContainmentEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this, CapellacorePackage.ENUMERATION_PROPERTY_TYPE__OWNED_LITERALS);
		}
