...
public class CtxPackageImpl extends EPackageImpl implements CtxPackage {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(systemEClass, org.sample.melangeproject.capellawithmass.ctx.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_ContributedCapabilities(), this.getCapability(), this.getCapability_ParticipatingSystem(), "contributedCapabilities", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_ParticipationsInCapabilities(), this.getSystemCapabilityInvolvement(), this.getSystemCapabilityInvolvement_System(), "participationsInCapabilities", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_ContributedMissions(), this.getMission(), this.getMission_ParticipatingSystem(), "contributedMissions", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_ParticipationsInMissions(), this.getSystemMissionInvolvement(), this.getSystemMissionInvolvement_System(), "participationsInMissions", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_ExternalCommunication(), this.getSystemCommunicationHook(), null, "externalCommunication", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_OwnedEntityRealizations(), this.getOperationalEntityRealization(), null, "ownedEntityRealizations", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_AllocatedEntityRealizations(), this.getOperationalEntityRealization(), null, "allocatedEntityRealizations", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_AllocatedSystemFunctions(), this.getSystemFunction(), this.getSystemFunction_AllocatorSystems(), "allocatedSystemFunctions", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_RealizedEntities(), theOaPackage.getEntity(), null, "realizedEntities", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_RealizingLogicalComponents(), theLaPackage.getLogicalComponent(), theLaPackage.getLogicalComponent_RealizedSystems(), "realizingLogicalComponents", null, 0, -1, org.sample.melangeproject.capellawithmass.ctx.System.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMission_OwnedCapabilityExploitations(), this.getCapabilityExploitation(), this.getCapabilityExploitation_Mission(), "ownedCapabilityExploitations", null, 0, -1, Mission.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCapability_Purposes(), this.getCapabilityExploitation(), this.getCapabilityExploitation_Capability(), "purposes", null, 0, -1, Capability.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCapabilityExploitation_Mission(), this.getMission(), this.getMission_OwnedCapabilityExploitations(), "mission", null, 1, 1, CapabilityExploitation.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCapabilityExploitation_Capability(), this.getCapability(), this.getCapability_Purposes(), "capability", null, 1, 1, CapabilityExploitation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
