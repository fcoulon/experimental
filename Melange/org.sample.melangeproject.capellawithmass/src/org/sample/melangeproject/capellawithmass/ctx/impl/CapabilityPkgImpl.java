 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.impl.CapabilityPkgImpl#getOwnedCapabilities <em>Owned Capabilities</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.impl.CapabilityPkgImpl#getOwnedCapabilityPkgs <em>Owned Capability Pkgs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityPkgImpl extends AbstractCapabilityPkgImpl implements CapabilityPkg {
	...
	public EList<Capability> getOwnedCapabilities() {
		if (ownedCapabilities == null) {
			ownedCapabilities = new EObjectContainmentEList<Capability>(Capability.class, this, CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITIES);
		}
	...
	public EList<CapabilityPkg> getOwnedCapabilityPkgs() {
		if (ownedCapabilityPkgs == null) {
			ownedCapabilityPkgs = new EObjectContainmentEList<CapabilityPkg>(CapabilityPkg.class, this, CtxPackage.CAPABILITY_PKG__OWNED_CAPABILITY_PKGS);
		}
