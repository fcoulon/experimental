 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.SystemCommunicationHook#getCommunication <em>Communication</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.SystemCommunicationHook#getType <em>Type</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getSystemCommunicationHook()
...
public interface SystemCommunicationHook extends NamedElement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getSystemCommunicationHook_Communication()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.ctx.SystemCommunicationHook#getCommunication <em>Communication</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getSystemCommunicationHook_Type()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.ctx.SystemCommunicationHook#getType <em>Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
