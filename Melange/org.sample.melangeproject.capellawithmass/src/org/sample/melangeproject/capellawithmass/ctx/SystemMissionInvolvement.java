 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.SystemMissionInvolvement#getMission <em>Mission</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.SystemMissionInvolvement#getSystem <em>System</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getSystemMissionInvolvement()
...
public interface SystemMissionInvolvement extends Involvement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.ctx.Mission#getInvolvedSystem <em>Involved System</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getSystemMissionInvolvement_Mission()
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.ctx.System#getParticipationsInMissions <em>Participations In Missions</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getSystemMissionInvolvement_System()
