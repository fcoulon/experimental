 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.ActorMissionInvolvement#getActor <em>Actor</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.ctx.ActorMissionInvolvement#getMission <em>Mission</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getActorMissionInvolvement()
...
public interface ActorMissionInvolvement extends Involvement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.ctx.Actor#getParticipationsInMissions <em>Participations In Missions</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getActorMissionInvolvement_Actor()
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.ctx.Mission#getInvolvedActors <em>Involved Actors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.ctx.CtxPackage#getActorMissionInvolvement_Mission()
