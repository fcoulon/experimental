 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPath#getInvolvedLinks <em>Involved Links</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPath#getOwnedPhysicalPathInvolvements <em>Owned Physical Path Involvements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPath#getFirstPhysicalPathInvolvements <em>First Physical Path Involvements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPath#getOwnedPhysicalPathRealizations <em>Owned Physical Path Realizations</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPath#getRealizedPhysicalPaths <em>Realized Physical Paths</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPath#getRealizingPhysicalPaths <em>Realizing Physical Paths</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getPhysicalPath()
...
public interface PhysicalPath extends NamedElement, ComponentExchangeAllocator, AbstractPathInvolvedElement, InvolverElement {
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.cs.AbstractPhysicalPathLink}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getPhysicalPath_InvolvedLinks()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.cs.PhysicalPathInvolvement}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getPhysicalPath_OwnedPhysicalPathInvolvements()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.cs.PhysicalPathRealization}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getPhysicalPath_OwnedPhysicalPathRealizations()
	 * @model containment="true"
