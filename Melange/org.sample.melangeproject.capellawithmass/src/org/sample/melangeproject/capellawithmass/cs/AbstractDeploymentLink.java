 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.AbstractDeploymentLink#getDeployedElement <em>Deployed Element</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.AbstractDeploymentLink#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getAbstractDeploymentLink()
 * @model abstract="true"
...
public interface AbstractDeploymentLink extends Relationship {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getAbstractDeploymentLink_DeployedElement()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.cs.AbstractDeploymentLink#getDeployedElement <em>Deployed Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getAbstractDeploymentLink_Location()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.cs.AbstractDeploymentLink#getLocation <em>Location</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
