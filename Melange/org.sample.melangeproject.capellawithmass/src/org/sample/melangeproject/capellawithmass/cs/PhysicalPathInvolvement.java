 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPathInvolvement#getNextInvolvements <em>Next Involvements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPathInvolvement#getPreviousInvolvements <em>Previous Involvements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPathInvolvement#getInvolvedElement <em>Involved Element</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.PhysicalPathInvolvement#getInvolvedComponent <em>Involved Component</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getPhysicalPathInvolvement()
...
public interface PhysicalPathInvolvement extends Involvement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.cs.CsPackage#getPhysicalPathInvolvement_NextInvolvements()
