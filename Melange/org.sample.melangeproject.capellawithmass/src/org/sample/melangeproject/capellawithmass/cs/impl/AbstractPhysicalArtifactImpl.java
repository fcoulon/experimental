 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getIncomingTraces <em>Incoming Traces</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getOutgoingTraces <em>Outgoing Traces</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#isVisibleInDoc <em>Visible In Doc</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#isVisibleInLM <em>Visible In LM</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getReview <em>Review</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getOwnedPropertyValues <em>Owned Property Values</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getOwnedEnumerationPropertyTypes <em>Owned Enumeration Property Types</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getAppliedPropertyValues <em>Applied Property Values</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getOwnedPropertyValueGroups <em>Owned Property Value Groups</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getAppliedPropertyValueGroups <em>Applied Property Value Groups</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getAppliedRequirements <em>Applied Requirements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.cs.impl.AbstractPhysicalArtifactImpl#getAllocatorConfigurationItems <em>Allocator Configuration Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractPhysicalArtifactImpl extends ModelElementImpl implements AbstractPhysicalArtifact {
	...
	public void setVisibleInDoc(boolean newVisibleInDoc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_DOC, oldVisibleInDoc, visibleInDoc));
	}
	...
	public void setVisibleInLM(boolean newVisibleInLM) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_LM, oldVisibleInLM, visibleInLM));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__INCOMING_TRACES:
				return getIncomingTraces();
			case CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__OUTGOING_TRACES:
				return getOutgoingTraces();
			case CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_DOC:
				return isVisibleInDoc();
			case CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_LM:
			...
			case CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__ALLOCATOR_CONFIGURATION_ITEMS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PublishableElement.class) {
			switch (derivedFeatureID) {
				case CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_DOC: return ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC;
				case CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_LM: return ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PublishableElement.class) {
			switch (baseFeatureID) {
				case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC: return CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_DOC;
				case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM: return CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__VISIBLE_IN_LM;
				default: return -1;
			}
		}
