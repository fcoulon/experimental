 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.impl.LogicalActorPkgImpl#getOwnedLogicalActorPkgs <em>Owned Logical Actor Pkgs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.impl.LogicalActorPkgImpl#getOwnedLogicalActors <em>Owned Logical Actors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalActorPkgImpl extends AbstractFunctionalStructureImpl implements LogicalActorPkg {
	...
	public EList<LogicalActorPkg> getOwnedLogicalActorPkgs() {
		if (ownedLogicalActorPkgs == null) {
			ownedLogicalActorPkgs = new EObjectContainmentEList<LogicalActorPkg>(LogicalActorPkg.class, this, LaPackage.LOGICAL_ACTOR_PKG__OWNED_LOGICAL_ACTOR_PKGS);
		}
	...
	public EList<LogicalActor> getOwnedLogicalActors() {
		if (ownedLogicalActors == null) {
			ownedLogicalActors = new EObjectContainmentEList<LogicalActor>(LogicalActor.class, this, LaPackage.LOGICAL_ACTOR_PKG__OWNED_LOGICAL_ACTORS);
		}
