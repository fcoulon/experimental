 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.impl.LogicalComponentPkgImpl#getOwnedLogicalComponents <em>Owned Logical Components</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.impl.LogicalComponentPkgImpl#getOwnedLogicalComponentPkgs <em>Owned Logical Component Pkgs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalComponentPkgImpl extends AbstractFunctionalStructureImpl implements LogicalComponentPkg {
	...
	public EList<LogicalComponent> getOwnedLogicalComponents() {
		if (ownedLogicalComponents == null) {
			ownedLogicalComponents = new EObjectContainmentEList<LogicalComponent>(LogicalComponent.class, this, LaPackage.LOGICAL_COMPONENT_PKG__OWNED_LOGICAL_COMPONENTS);
		}
	...
	public EList<LogicalComponentPkg> getOwnedLogicalComponentPkgs() {
		if (ownedLogicalComponentPkgs == null) {
			ownedLogicalComponentPkgs = new EObjectContainmentEList<LogicalComponentPkg>(LogicalComponentPkg.class, this, LaPackage.LOGICAL_COMPONENT_PKG__OWNED_LOGICAL_COMPONENT_PKGS);
		}
