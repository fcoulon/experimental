 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.LogicalActorPkg#getOwnedLogicalActorPkgs <em>Owned Logical Actor Pkgs</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.LogicalActorPkg#getOwnedLogicalActors <em>Owned Logical Actors</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.la.LaPackage#getLogicalActorPkg()
...
public interface LogicalActorPkg extends AbstractFunctionalStructure {
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.la.LogicalActorPkg}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.la.LaPackage#getLogicalActorPkg_OwnedLogicalActorPkgs()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.la.LaPackage#getLogicalActorPkg_OwnedLogicalActors()
	 * @model containment="true"
