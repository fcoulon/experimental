 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.CapabilityRealizationPkg#getOwnedCapabilityRealizations <em>Owned Capability Realizations</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.CapabilityRealizationPkg#getOwnedCapabilityRealizationPkgs <em>Owned Capability Realization Pkgs</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.la.LaPackage#getCapabilityRealizationPkg()
...
public interface CapabilityRealizationPkg extends AbstractCapabilityPkg {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.la.LaPackage#getCapabilityRealizationPkg_OwnedCapabilityRealizations()
	 ...
	 * The list contents are of type {@link org.sample.melangeproject.capellawithmass.la.CapabilityRealizationPkg}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.la.LaPackage#getCapabilityRealizationPkg_OwnedCapabilityRealizationPkgs()
	 * @model containment="true"
	 *        annotation="http://www.polarsys.org/capella/2007/UML2Mapping featureName='packagedElement' featureOwner='Package'"
