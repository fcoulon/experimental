 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.impl.CapabilityRealizationPkgImpl#getOwnedCapabilityRealizations <em>Owned Capability Realizations</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.la.impl.CapabilityRealizationPkgImpl#getOwnedCapabilityRealizationPkgs <em>Owned Capability Realization Pkgs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityRealizationPkgImpl extends AbstractCapabilityPkgImpl implements CapabilityRealizationPkg {
	...
	public EList<CapabilityRealization> getOwnedCapabilityRealizations() {
		if (ownedCapabilityRealizations == null) {
			ownedCapabilityRealizations = new EObjectContainmentEList<CapabilityRealization>(CapabilityRealization.class, this, LaPackage.CAPABILITY_REALIZATION_PKG__OWNED_CAPABILITY_REALIZATIONS);
		}
	...
	public EList<CapabilityRealizationPkg> getOwnedCapabilityRealizationPkgs() {
		if (ownedCapabilityRealizationPkgs == null) {
			ownedCapabilityRealizationPkgs = new EObjectContainmentEList<CapabilityRealizationPkg>(CapabilityRealizationPkg.class, this, LaPackage.CAPABILITY_REALIZATION_PKG__OWNED_CAPABILITY_REALIZATION_PKGS);
		}
