 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.ExchangeCategory#getExchanges <em>Exchanges</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getExchangeCategory()
...
public interface ExchangeCategory extends NamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.fa.FunctionalExchange#getCategories <em>Categories</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getExchangeCategory_Exchanges()
