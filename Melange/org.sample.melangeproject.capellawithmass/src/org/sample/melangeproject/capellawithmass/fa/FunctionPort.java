 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.FunctionPort#getRepresentedComponentPort <em>Represented Component Port</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.FunctionPort#getAllocatorComponentPorts <em>Allocator Component Ports</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.FunctionPort#getRealizedFunctionPorts <em>Realized Function Ports</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.FunctionPort#getRealizingFunctionPorts <em>Realizing Function Ports</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getFunctionPort()
 * @model abstract="true"
...
public interface FunctionPort extends Port, TypedElement {
	 ...
	 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getFunctionPort_RepresentedComponentPort()
	...
	/**
	 * Sets the value of the '{@link org.sample.melangeproject.capellawithmass.fa.FunctionPort#getRepresentedComponentPort <em>Represented Component Port</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.fa.ComponentPort#getAllocatedFunctionPorts <em>Allocated Function Ports</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getFunctionPort_AllocatorComponentPorts()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getFunctionPort_RealizedFunctionPorts()
	 ...
	 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getFunctionPort_RealizingFunctionPorts()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.polarsys.org/capella/semantic excludefrom='xmlpivot'"
	 *        annotation="http://www.polarsys.org/capella/MNoE/CapellaLike/Mapping UML/SysML\040semantic\040equivalences='keyword::none' explanation='Derived and transient' constraints='none'"
	 * @generated
