...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Output Port</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getInActivityPartition <em>In Activity Partition</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getInInterruptibleRegion <em>In Interruptible Region</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getInStructuredNode <em>In Structured Node</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#isIsControlType <em>Is Control Type</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getKindOfNode <em>Kind Of Node</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getInState <em>In State</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getSelection <em>Selection</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#isIsControl <em>Is Control</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getOutgoingExchangeItems <em>Outgoing Exchange Items</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.FunctionOutputPortImpl#getOutgoingFunctionalExchanges <em>Outgoing Functional Exchanges</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionOutputPortImpl extends FunctionPortImpl implements FunctionOutputPort {
	...
	public EList<FunctionalExchange> getOutgoingFunctionalExchanges() {
		// TODO: implement this method to return the 'Outgoing Functional Exchanges' reference list
		// Ensure that you remove @generated or mark it @generated NOT
		// The list is expected to implement org.eclipse.emf.ecore.util.InternalEList and org.eclipse.emf.ecore.EStructuralFeature.Setting
		// so it's likely that an appropriate subclass of org.eclipse.emf.ecore.util.EcoreEList should be used.
		throw new UnsupportedOperationException();
