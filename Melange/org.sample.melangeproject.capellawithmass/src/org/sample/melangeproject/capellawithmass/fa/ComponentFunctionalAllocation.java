 ...
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.ComponentFunctionalAllocation#getFunction <em>Function</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.ComponentFunctionalAllocation#getBlock <em>Block</em>}</li>
 * </ul>
 *
 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getComponentFunctionalAllocation()
...
public interface ComponentFunctionalAllocation extends AbstractFunctionAllocation {
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.fa.AbstractFunction#getComponentFunctionalAllocations <em>Component Functional Allocations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getComponentFunctionalAllocation_Function()
	 ...
	 * It is bidirectional and its opposite is '{@link org.sample.melangeproject.capellawithmass.fa.AbstractFunctionalBlock#getFunctionalAllocations <em>Functional Allocations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.sample.melangeproject.capellawithmass.fa.FaPackage#getComponentFunctionalAllocation_Block()
