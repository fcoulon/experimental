...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Component Port Allocation End</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getIncomingTraces <em>Incoming Traces</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getOutgoingTraces <em>Outgoing Traces</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#isVisibleInDoc <em>Visible In Doc</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#isVisibleInLM <em>Visible In LM</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getReview <em>Review</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getOwnedPropertyValues <em>Owned Property Values</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getOwnedEnumerationPropertyTypes <em>Owned Enumeration Property Types</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getAppliedPropertyValues <em>Applied Property Values</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getOwnedPropertyValueGroups <em>Owned Property Value Groups</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getAppliedPropertyValueGroups <em>Applied Property Value Groups</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getAppliedRequirements <em>Applied Requirements</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getPort <em>Port</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getPart <em>Part</em>}</li>
 *   <li>{@link org.sample.melangeproject.capellawithmass.fa.impl.ComponentPortAllocationEndImpl#getOwningComponentPortAllocation <em>Owning Component Port Allocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentPortAllocationEndImpl extends ModelElementImpl implements ComponentPortAllocationEnd {
	/**
	 ...
	 * @generated
	 */
	protected ComponentPortAllocationEndImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FaPackage.Literals.COMPONENT_PORT_ALLOCATION_END;
	}
	...
	public void setVisibleInDoc(boolean newVisibleInDoc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_DOC, oldVisibleInDoc, visibleInDoc));
	}
	...
	public void setVisibleInLM(boolean newVisibleInLM) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_LM, oldVisibleInLM, visibleInLM));
	}
	...
	public void setSummary(String newSummary) {
		...
		summary = newSummary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__SUMMARY, oldSummary, summary));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__DESCRIPTION, oldDescription, description));
	}
	...
	public void setReview(String newReview) {
		...
		review = newReview;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__REVIEW, oldReview, review));
	}
	...
	public EList<AbstractPropertyValue> getOwnedPropertyValues() {
		if (ownedPropertyValues == null) {
			ownedPropertyValues = new EObjectContainmentEList<AbstractPropertyValue>(AbstractPropertyValue.class, this, FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_PROPERTY_VALUES);
		}
	...
	public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
		if (ownedEnumerationPropertyTypes == null) {
			ownedEnumerationPropertyTypes = new EObjectContainmentEList<EnumerationPropertyType>(EnumerationPropertyType.class, this, FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_ENUMERATION_PROPERTY_TYPES);
		}
	...
	public EList<AbstractPropertyValue> getAppliedPropertyValues() {
		if (appliedPropertyValues == null) {
			appliedPropertyValues = new EObjectResolvingEList<AbstractPropertyValue>(AbstractPropertyValue.class, this, FaPackage.COMPONENT_PORT_ALLOCATION_END__APPLIED_PROPERTY_VALUES);
		}
	...
	public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
		if (ownedPropertyValueGroups == null) {
			ownedPropertyValueGroups = new EObjectContainmentEList<PropertyValueGroup>(PropertyValueGroup.class, this, FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_PROPERTY_VALUE_GROUPS);
		}
	...
	public EList<PropertyValueGroup> getAppliedPropertyValueGroups() {
		if (appliedPropertyValueGroups == null) {
			appliedPropertyValueGroups = new EObjectResolvingEList<PropertyValueGroup>(PropertyValueGroup.class, this, FaPackage.COMPONENT_PORT_ALLOCATION_END__APPLIED_PROPERTY_VALUE_GROUPS);
		}
	...
	public EnumerationPropertyLiteral getStatus() {
		if (status != null && status.eIsProxy()) {
			...
			if (status != oldStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.COMPONENT_PORT_ALLOCATION_END__STATUS, oldStatus, status));
			}
		}
		return status;
	}
	...
	public void setStatus(EnumerationPropertyLiteral newStatus) {
		...
		status = newStatus;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__STATUS, oldStatus, status));
	}
	...
	public EList<EnumerationPropertyLiteral> getFeatures() {
		if (features == null) {
			features = new EObjectResolvingEList<EnumerationPropertyLiteral>(EnumerationPropertyLiteral.class, this, FaPackage.COMPONENT_PORT_ALLOCATION_END__FEATURES);
		}
		return features;
	}
	...
	public Port getPort() {
		if (port != null && port.eIsProxy()) {
			...
			if (port != oldPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.COMPONENT_PORT_ALLOCATION_END__PORT, oldPort, port));
			}
		}
		return port;
	}
	...
	public void setPort(Port newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__PORT, oldPort, port));
	}
	...
	public Part getPart() {
		if (part != null && part.eIsProxy()) {
			...
			if (part != oldPart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FaPackage.COMPONENT_PORT_ALLOCATION_END__PART, oldPart, part));
			}
		}
		return part;
	}
	...
	public void setPart(Part newPart) {
		...
		part = newPart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FaPackage.COMPONENT_PORT_ALLOCATION_END__PART, oldPart, part));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_ENUMERATION_PROPERTY_TYPES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__INCOMING_TRACES:
				return getIncomingTraces();
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__OUTGOING_TRACES:
			...
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__APPLIED_PROPERTY_VALUES:
				return getAppliedPropertyValues();
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNED_PROPERTY_VALUE_GROUPS:
				return getOwnedPropertyValueGroups();
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__APPLIED_PROPERTY_VALUE_GROUPS:
			...
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__PART:
				...
				return basicGetPart();
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNING_COMPONENT_PORT_ALLOCATION:
				return getOwningComponentPortAllocation();
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__PART:
				return part != null;
			case FaPackage.COMPONENT_PORT_ALLOCATION_END__OWNING_COMPONENT_PORT_ALLOCATION:
				return getOwningComponentPortAllocation() != null;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PublishableElement.class) {
			switch (derivedFeatureID) {
				case FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_DOC: return ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC;
				case FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_LM: return ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PublishableElement.class) {
			switch (baseFeatureID) {
				case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_DOC: return FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_DOC;
				case ModellingcorePackage.PUBLISHABLE_ELEMENT__VISIBLE_IN_LM: return FaPackage.COMPONENT_PORT_ALLOCATION_END__VISIBLE_IN_LM;
				default: return -1;
			}
		}
...
} //ComponentPortAllocationEndImpl
