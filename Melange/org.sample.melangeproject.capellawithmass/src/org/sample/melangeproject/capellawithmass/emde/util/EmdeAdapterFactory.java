/**
 */
package org.sample.melangeproject.capellawithmass.emde.util;
...
import org.sample.melangeproject.capellawithmass.emde.*;
...
public class EmdeAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EmdeSwitch<Adapter> modelSwitch =
		new EmdeSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sample.melangeproject.capellawithmass.emde.ElementExtension <em>Element Extension</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
